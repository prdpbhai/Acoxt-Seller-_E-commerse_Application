...
public class Adapter_recy_Acoxt extends RecyclerView.Adapter<Adapter_recy_Acoxt.ViewHolder> {
    ...
    public Adapter_recy_Acoxt(List<Acoxt_fregment_vertical_item_pojo.Datum> acoxt_fregment_vertical_item_pojos, Context context, DB_Helper dbHelper) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        Acoxt_fregment_vertical_item_pojo.Datum item = acoxt_fregment_vertical_item_pojos.get(position);
        ...
        List<String> imgList = item.getImg();
        ...
        holder.home_img.setOnClickListener(v -> {
...
//                intent.putExtra("addid",acoxt_fregment_vertical_item_pojos.get(position).getId());
                ...
                editor.putString("addproductid",category_Id);
                editor.apply();
                Log.d("gkmtkmgekwefrowf", ""+category_Id);
                context.startActivity(intent);
            }
        });
...
//              holder.linear_add.setVisibility(View.VISIBLE);           Log.e("","");
//                    }
//                });
//
//                holder.add_product.setVisibility(View.GONE);
